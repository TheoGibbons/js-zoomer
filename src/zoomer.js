  ...
  return {
    ...
    init: function () {
      ...
      $('.zoomer-container').each(function () {
        ...
        // If the container doesn't have a width or height, set it
        function containerInit() {
          ...
          if (!containerWidth) {
            const newWidth = containerHeight ? containerHeight * imgWidth / imgHeight : imgWidth
            $container.css({width: newWidth + 'px'});
          }
          if (!containerHeight) {
            const newHeight = containerWidth ? containerWidth * imgHeight / imgWidth : imgHeight
